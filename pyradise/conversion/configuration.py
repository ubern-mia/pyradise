...
class ModalityConfiguration:
    """Represents a configuration managing the modality handling."""
    ...
    def _get_modality_for_series_instance_uid(self,
        ...
        Args:
            ...
            force (bool): If true, there will always be a returned modality information. Otherwise a None value may be
             returned.
