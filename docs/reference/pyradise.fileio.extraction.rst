...
:class:`~pyradise.data.modality.Modality`, :class:`~pyradise.data.organ.Organ`, and
:class:`~pyradise.data.annotator.Annotator` instances. Typically, extractors are used in combination with a
:class:`~pyradise.fileio.crawling.Crawler` to retrieve the necessary information for
:class:`~pyradise.data.subject.Subject` construction which happens during loading.
...
+-----------------------------------------+----------------------------------------------------------------------------------------------------------------------------+
| :class:`AnnotatorExtractor`             | Prototype :class:`Extractor` for :class:`~pyradise.data.annotator.Annotator` extraction from discrete images.              |
+-----------------------------------------+----------------------------------------------------------------------------------------------------------------------------+
...
+-----------------------------------------+---------------------------------------+
| :class:`SimpleAnnotatorExtractor`       | A simple :class:`AnnotatorExtractor`. |
+-----------------------------------------+---------------------------------------+
