...
@dataclass
class RTSSMetaData:
    """A class to define and hold the modifiable metadata of an RTSS file.
    ...
    Note:
        The ``approval_status`` attribute takes only the following values: ``'UNAPPROVED'``, ``'APPROVED'`` and
        ``'REJECTED'``.
    ...
    Args:
        ...
        operators_name (str): The operator's name (default: 'PyRaDiSe Converter Algorithm').
    ...
    operators_name: str = 'PyRaDiSe Converter Algorithm'
...
class SubjectToRTSSConverter(Converter):
    ...
    def convert(self) -> Dataset:
        ...
        rtss = SegmentToRTSSConverter(tuple(sitk_images), image_datasets, tuple(label_names), None,
                                      ...
                                      self.smoothing_kernel_size, self.meta_data).convert()
