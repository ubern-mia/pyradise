...
shutil.copyfile(
    os.path.join(basedir, "examples", "conversion", "dicom_to_nii.ipynb"),
    os.path.join(basedir, "docs", "examples.conversion.dicom_to_nii.ipynb"),
)

shutil.copyfile(
    os.path.join(basedir, "examples", "conversion", "nii_to_dicom.ipynb"),
    os.path.join(basedir, "docs", "examples.conversion.nii_to_dicom.ipynb"),
)

shutil.copyfile(
    os.path.join(basedir, "examples", "inference", "basic.ipynb"),
    os.path.join(basedir, "docs", "examples.inference.basic.ipynb"),
)

shutil.copyfile(
    os.path.join(basedir, "examples", "inference", "container.ipynb"),
    os.path.join(basedir, "docs", "examples.inference.container.ipynb"),
)

shutil.copyfile(
    os.path.join(basedir, "examples", "processing", "basic_processing.ipynb"),
...
intersphinx_mapping = {
    "itk": ("https://itk.org/Doxygen/html/", os.path.join(_temporary_directory, "itk.inv")),
    "SimpleITK": ("https://simpleitk.org/doxygen/latest/html/", os.path.join(_temporary_directory, "sitk.inv")),
...
def create_sitk_inventory(output_dir: str) -> None:
    ...
    objects = (
        "SimpleITK.Image py:class 0 classitk_1_1simple_1_1Image.html -\n"
